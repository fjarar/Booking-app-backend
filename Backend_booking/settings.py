"""
Django settings for Backend_booking project.
...
# Check if running on Render (or another production environment)
...
ROOT_URLCONF = 'Backend_booking.urls'
...
WSGI_APPLICATION = 'Backend_booking.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        ...
        'rest_framework.renderers.BrowsableAPIRenderer',  # Keep this for UI
    )
}
